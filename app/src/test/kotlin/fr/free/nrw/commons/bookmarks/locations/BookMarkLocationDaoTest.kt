...
class BookMarkLocationDaoTest {
    ...
    fun setUp() {
        ...
        examplePlaceBookmark = Place("placeName", exampleLabel, "placeDescription"
                , exampleLocation, "placeCategory", builder.build(),"placePic","placeDestroyed")
    ...
    fun migrateTableVersionFrom_v10_to_v11() {
        ...
        verify(database).execSQL("ALTER TABLE bookmarksLocations ADD COLUMN location_pic STRING;")
    }
    ...
    private fun createCursor(rowCount: Int) = MatrixCursor(columns, rowCount).apply {
        ...
        for (i in 0 until rowCount) {
            addRow(listOf("placeName", "placeDescription","placeCategory", exampleLabel.text, exampleLabel.icon,
                    ...
                    exampleLocation.latitude, exampleLocation.longitude, "placePic", "placeDestroyed"))
        }
    }
}
